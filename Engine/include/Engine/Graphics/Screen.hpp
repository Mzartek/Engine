...
namespace Engine
{
		namespace Graphics
		{
				...
				private:
						...
						std::shared_ptr<ShaderProgram> _windowsProgram;
						GLuint _idVAO;

				public:
						Screen(const std::shared_ptr<ShaderProgram> &backgroundProgram, const std::shared_ptr<ShaderProgram> &windowsProgram);
						~Screen(void);
