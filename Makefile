...
SRC= GL.cpp Object.cpp Window.cpp Camera.cpp MovableCamera.cpp FreeCam.cpp PlayerCam.cpp ShaderProgram.cpp GLcontext.cpp Model.cpp OBJModel.cpp matrix.cpp
OBJ= $(SRC:%.cpp=obj/%.o)
